...
public class SquareLogoRenderer implements LogoRenderer {
    ...
    public void drawLogo(
        ...
        if (isTransparent) {
            ...
            g.setClip(new Rectangle2D.Double(x, y, targetSize, targetSize));
            ...
            g.fill(new Rectangle2D.Double(x, y, targetSize, targetSize));
            ...
            Shape oldClip = g.getClip();
            g.setClip(new Rectangle2D.Double(innerX, innerY, innerSize, innerSize));
