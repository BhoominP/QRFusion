...
export const NavTabs: React.FC<NavTabsProps> = ({
  ...
  return (
    <div
      className={cn(
        'flex items-center gap-1.5 p-1.5 bg-border/40 dark:bg-surface-glass rounded-xl border border-border/50 overflow-x-auto no-scrollbar flex-nowrap relative select-none w-full mb-4',
        className
      )}
    >
      {tabs.map((tab) => {
